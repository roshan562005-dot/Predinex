  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 pb-20 md:pb-8 relative">
      ...
      <motion.div
        ...
        className="relative z-10 bg-gradient-to-r from-primary-50 to-blue-50 dark:from-primary-500/10 dark:to-blue-500/10 border border-primary-200 dark:border-primary-500/20 rounded-2xl p-5 flex flex-col sm:flex-row items-center justify-between gap-4"
      >
